        ...
        {!isLoginPage && (
            <header className="hidden md:flex bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200/60 dark:border-slate-800 px-8 py-4 justify-between items-center sticky top-0 z-50 transition-all duration-300">
                <div className="flex flex-col">
                    <div className="font-black text-2xl text-red-600 dark:text-red-500 uppercase tracking-tighter leading-none flex items-center gap-2">
                        <span className="bg-red-600 text-white w-8 h-8 rounded-lg flex items-center justify-center text-lg">C</span>
                        XE MÁY CÀ REM
                    </div>
